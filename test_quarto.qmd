...
# Set CRAN mirror
chooseCRANmirror(graphics = FALSE, ind = 1)  # You can adjust the index for the desired mirror
# Set Bioconductor mirror
BiocManager::chooseBioCmirror(ind = 1)  # Adjust the index for your preferred Bioconductor mirror
