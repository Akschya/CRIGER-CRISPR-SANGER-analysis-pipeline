...
output_path_plots <- paste0(output_dir, "Outputs/Plots")
output_path_results <-  paste0(output_dir, "Outputs/Results")
```
...
## Chromatogram
#chromatogram(int, width = length(int@primarySeq), height = 5, showcalls = "both")
chromatogram_path <- file.path(output_path_plots, "chromatogram.png")
```

```{=html}
<div style="overflow-x: auto; white-space: nowrap;">
  <img src="{{ output_path_plots }}/chromatogram.png" width="{{ wdt }}">
  </div>
```
