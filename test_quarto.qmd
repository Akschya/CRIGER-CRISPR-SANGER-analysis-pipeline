...
# Set CRAN mirror to a specific URL (e.g., for USA)
options(repos = c(CRAN = "https://cran.rstudio.com"))
# Set Bioconductor mirror to a specific URL
BiocManager::install(version = "3.17", repos = "https://bioconductor.org/packages/release/bioc")
